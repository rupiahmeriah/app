                      ...
                      <div className="mt-6 grid grid-cols-4 gap-6">
                        <div className="col-span-4 sm:col-span-2">
                          ...
                          <input
                            ...
                            className="mt-1 block w-full rounded-md border border-slate-300 py-2 px-3 shadow-sm focus:border-slate-900 focus:outline-none focus:ring-slate-900 sm:text-sm"
                          />
                        </div>
                        ...
                        <div className="col-span-4 sm:col-span-1">
                          ...
                          >
                            ...
                            <QuestionMarkCircleIcon
                              className="ml-1 h-5 w-5 flex-shrink-0 text-slate-300"
                              aria-hidden="true"
                            />
                          </label>
                          <input
                        ...
                        <div className="col-span-4 sm:col-span-2">
                          ...
                          <select
                            ...
                            className="mt-1 block w-full rounded-md border border-slate-300 bg-white py-2 px-3 shadow-sm focus:border-slate-900 focus:outline-none focus:ring-slate-900 sm:text-sm"
                          >
